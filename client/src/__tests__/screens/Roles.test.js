...
const setup = (initialState = {}) => {
  ...
  const Composition = connect(null, { getRoles })(withStyles(Wrapper, { withTheme: true })(withRouter(Roles)));
  const props = {
    history: history,
    roles: mocks.ROLES
  };
  ...
  /**
   *  Renders roles main screen form with styles,
  ...
  describe('Roles screen', () => {
    it('Should render HOC with styles properly', () => {
      ...
      expect(wrapper.find('h2').text()).toBe('Roles');
