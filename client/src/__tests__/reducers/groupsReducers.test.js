...
import groupsReducer, { displayStatus } from '../../reducers/groupsReducer';
...
const setup = () => {
  ...
  describe('GROUPS reducers', () => {
    ...
    it('FETCH GROUPS', () => {
      ...
      expect(groupsReducer({}, expectedActions)).toEqual({
        group: {},
    ...
    it('CONFIRM NOTIFICATION', () => {
      ...
      expect(groupsReducer({}, expectedActions)).toMatchSnapshot();
    });
